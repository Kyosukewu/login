...
<form action="add_user.php" method="post" class="col-md-6">
    ...
    <li class="list-group-item">學歷：<select name="education" id="">
...
<input class="btn btn-primary my-3 mx-auto" type="submit" name="" id="" value="確認新增">
<input class="btn btn-warning my-3 mx-auto" type="reset" name="" id="" value="重置">
</form>
</div>
</body>
<?php
